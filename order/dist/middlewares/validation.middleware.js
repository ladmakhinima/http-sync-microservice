...
var validatorMiddleware = function (dto) {
    return function (request, response, next) { return __awaiter(void 0, void 0, void 0, function () {
        var transformedClass, errors;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    transformedClass = (0, class_transformer_1.plainToInstance)(dto, request.body);
                    return [4 /*yield*/, (0, class_validator_1.validate)(transformedClass)];
                case 1:
                    errors = _a.sent();
                    if (errors.length > 0) {
                        return [2 /*return*/, response.status(400).json({
                                message: "badrequest exception",
                                errors: errors.reduce(function (errors, er) {
